    ...
    */
    'drivers' => [
        ...
        'pasargad' => [
            ...
            'merchantId' => '4712818',
            'terminalCode' => '1903473',
            'certificate' => '<RSAKeyValue><Modulus>p7804cHlQ1iHkbSvClvJVpUGHJqB1ODYmk1It6XNSP1yLrIEDcy+Lov2xOrarkqVdkhXjklbZ6XpU9kUlPlttx7UZX34mMxgc5KQROh8YD7XHIBNGMF5U4bNE/i7TgkaB/4HPPT6lSPL0a+WsJn254NXEGhvNRe4EYg5KpQ1eos=</Modulus><Exponent>AQAB</Exponent><P>0JwH2t54B47YKTLzNTwUjTmF6UFY/UD1ufBS6m/3I0Rx8dGQKi15mb2zzQMOH0bEF2+0QnbNSdMGgb1F2pC7bQ==</P><Q>zdrBjVVLi0XwLNFBIqSglqKR3ak8Bwm5spwTezPr6p6d7fnIo3ZtVyVwZLhye4XW7vYPxcXEjRkZfweDbbsa1w==</Q><DP>EMMY1ntdxa2yrMzNQg/LzvU6T13S2raniANJhlDs2MadKUMfhGQXC0V09xoxvk2fYAq3v0dwg2gTc8VToZZTmQ==</DP><DQ>F9cr71hfhWO2KxqY9pAmYQu25PsCjrYboYnd37jlq6hvFe6FxBilFSCq4Z9S8udPOyGYNglvd//eKg4OtJikxQ==</DQ><InverseQ>JaX9ri0kNgifp4jFa8VFfUqvD1YCIbV+MGC3C2hGDKFG0AwQSHxwWTNshJuyplnK7Vf/rQ+QSQAmqQ3vQN+O+w==</InverseQ><D>FhbRqeDUhdfEkmVOn3iSvLoHAgE+k3/ARiFjL/u/Wps1S/zZF9AcQxjfN/MNNOJRaDACh5QVW0K3xPjTAwMNdVcf/IvJTaK0R6pDb3L7bL6yy152II7q82UZm0HBVa8a//VLQbIEcg/2H9Jw6JMbSNMzGzGXuXOw529E3gMXEzE=</D></RSAKeyValue>', // can be string (and set certificateType to xml_string) or an xml file path (and set cetificateType to xml_file)
            'certificateType' => 'xml_string', // can be: xml_file, xml_string
            'callbackUrl' => 'http://arshiarahsazmachine.com',
        ],
        'payir' => [
